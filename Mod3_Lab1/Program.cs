    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                // Reads all aharacters from the current position to the end of the stream
                ...
                Console.WriteLine("The file has {0} text elements.", new StringInfo(contents).LegthInTextElements);
            }
            ...
            {
                // Informs user ther is no file created
